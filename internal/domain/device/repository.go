...
type Repository interface {
	...
	UpdatePolicyEvaluationByID(ctx context.Context, deviceID, status, policyAction, policyReason, trustLevel, lastPolicyDecision string, evaluatedAt time.Time) error
